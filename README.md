...
## Step 1 - Deploy Project Environment
 
**_Deliverables for Step 1:_**
* **E1T4.txt** - Text file identifying 2 poor security practices with justification. 
 
### 1:  Review Architecture Diagram
An architecture diagram has been provided which reflects the resources that will be deployed in your AWS account.
...
```
aws cloudformation create-stack --region us-east-1 --stack-name c3-app --template-body file://c3-app.yml --parameters ParameterKey=KeyPair,ParameterValue=<add your key pair name here> --capabilities CAPABILITY_IAM
```
...
### 1: Enable Security Monitoring using AWS Native Tools
...
### 2: Identify and Triage Vulnerabilities
 
Please record screenshots of:
...
Research and analyze which of the vulnerabilities appear to be related to the code that was deployed for the environment in this project. Provide recommendations on how to remediate the vulnerabilities. Record your findings in E2T2.txt
...
**_Deliverables for Step 3:_**
- **E3T1_guardduty.png** - Screenshot of Guard Duty findings specific to the Step 3, 1 attack.
- **E3T1.txt** - Answer to the questions at the end of Step 3, 1.
- **E3T2_s3breach.png** - Screenshot showing the resulting breach after the brute force attack.
- **3** - Screenshots showing attack attempts and monitoring or logs from the WAF showing blocked attempts.
...
Record text answers in E3T1.txt.
...
Record screenshots of your attempts and monitoring or logs from the WAF showing the blocked attempts.

**Deliverables:**
- **E3T2_s3breach.png** - Screenshot showing the resulting breach after the brute force attack.
- **3** - Screenshots showing attack attempts and monitoring or logs from the WAF showing blocked attempts.

## Step 4 - Implement Security Hardening

**_Deliverables for Step 4:_**
- **E4T1.txt** - Answer to the prompts in Step 4, 1.
...
- **E4T4.txt** - Answers from prompts in Step 4, 4.
- **c3-app_solution.yml** and **c3-s3_solution.yml** - Updated cloud formation templates which reflect changes made in E4 tasks related to AWS configuration changes.
- **E4T5.txt** - Additional hardening suggestions from Step 4, 5.
...
```
2. Test that this made a difference.  Run the brute force attack again from Step 3, 1.  
...
3. Record a screenshot of the security group change and your SSH attempt.
...
3. Record a screenshot of the updated IAM policy and the attempt to copy the files. 
...
1. Go to AWS inspector and run the inspector scan that was run in Step 2.
...
4. Record screenshots of Inspector, Security Hub, and AWS Config titled E4T3_inspector.png, E4T3_securityhub.png, and E4T3_config.png respectively.
...
Record your answers in E4T4.txt.
...
Brainstorm and list additional hardening suggestions aside from those implemented that would protect the data in this environment. Record your answers in E4T5.txt.

**Deliverables**:
- **c3-app_solution.yml** and **c3-s3_solution.yml** - updated cloud formation templates which reflect changes made in E4 tasks related to AWS configuration changes.
- **E4T5.txt** - Additional hardening suggestions from Step 4, 5.

## Step 5 - Designing a DevSecOps Pipeline
...
**_Deliverables for Step 5:_**
- **DevSecOpsPipline.[ppt or png]** - Your updated pipeline.
- **E5T2.txt** - Answer from prompts in Step 5, 2.
- *Optional* **E5T3.png** - Screenshot of tool that has identified bad practices.
- *Optional* **E5T3.txt** - Answers from prompts in Step 5, 3.

### 1:  Design a DevSecOps pipeline
...
Record your design as a ppt or png image named DevSecOpsPipeline.[ppt or png].
...
Record your answers in E5T2.txt

**Deliverables**:
- **E5T2.txt** - Answer from prompts in Step 5, 2.

### 3 - Scanning Infrastructure Code
...
**Deliverables**:
- **E5T3.png** - Screenshot of tool that has identified bad practices.
- **E5T3.txt** - Answers from prompts in Step 5, 3.
